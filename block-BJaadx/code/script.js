...
console.log(`The length of the li is ${ul.children.length}`);
...
// let password=document.body.children[6].children[4];
let password=document.querySelector(`input[type="password"]`)

// 9. Select the input using the placeholder attribute selector with value `password` and store in `attrPassword`
let attrPassword=document.querySelector(`placeholder[type="password"]`)
...
console.log(`The total number of image is ${allImg.length}`)
